// Shared types for the GDB API bridge. Imported by both the Electron
// main process (electron/preload.ts) and the React renderer
// (src/types.ts re-exports these for the components).
